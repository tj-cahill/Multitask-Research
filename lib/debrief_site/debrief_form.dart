          ...
          child: Column(
            children: <Widget>[
              ...
              Padding(
                  ...
                  child: Text(
                    "If you would like to be contacted regarding a \$20 Amazon Gift Card as compensation for your participation, please provide your personal email address below. The provided email address will be used to transfer an electronic gift card in exchange for your successful participation in this study. Please allow up to 72 hours for receipt of your gift card.",
                    textAlign: TextAlign.center,
                    softWrap: true,
                    style: TextStyle(
                        fontFamily: "OpenSans",
