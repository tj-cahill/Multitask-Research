              ...
              Padding(
                ...
                child: RichText(
                  text: TextSpan(children: <TextSpan>[
                    TextSpan(
                      text:
                          "In this study you will be asked to complete two series of attention-testing exercises. The study should take approximately 15 minutes and must be completed in one uninterrupted session. In exchange for successfully completing this study, you will be offered a \$300 Amazon gift card. ",
                      style: TextStyle(
                          fontFamily: "OpenSans",
                          fontWeight: FontWeight.normal,
                          fontSize: 18,
